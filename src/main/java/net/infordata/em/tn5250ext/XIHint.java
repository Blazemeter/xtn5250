...
/**
 * XIHint � la classe che descrive le caratteristiche di un Hint.
 * Utilizzando i caratteri di controllo � possibile andare a capo inserire
 ...
 * Per esempio questo testo �: #grassetto grassetto# @corsivo corsivo corsivo@\n
