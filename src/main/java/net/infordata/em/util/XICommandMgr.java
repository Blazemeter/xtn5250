...
public class XICommandMgr {
   ...
   * se anActionCommand � null allora elimina l' oggetto da tale gestione.
   */
   ...
   * interfaccia XACommand ad un action command (sia esso generato da un men� o da un bottone)
   * <pre>
   * es.  
